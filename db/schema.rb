...
ActiveRecord::Schema.define(version: 20150204033657) do
  ...
  create_table "refinery_ironman_categories", force: true do |t|
    ...
    t.string   "product_index_template"
  end
  ...
  create_table "refinery_ironman_product_specifications", force: true do |t|
    t.integer  "product_id"
    t.string   "title"
    t.string   "value"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.boolean  "show_on_product_detail"
    t.boolean  "show_on_product_popover"
    t.integer  "category_id"
  end
