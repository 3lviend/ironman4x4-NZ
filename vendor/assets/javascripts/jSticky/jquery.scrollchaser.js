  ...
  var ScrollChaser = (function () {
    ...
    $.extend(ScrollChaser.prototype, {
      ...
      getSentinelBottom: cache(function () {
        var top = (this.$wrapper.offset() || { "top": NaN }).top;
        if (isNaN(top)) {
        } else {
          return this.$wrapper.offset().top + this.getWrapperHeight() + parseInt(this.$wrapper.css('margin-top'), 10);
        }        
      }),

      getBottom: cache(function () {
        var top = (this.$el.offset() || { "top": NaN }).top;
        if (isNaN(top)) {
        } else {        
          return top + this.getOuterHeight();
        }
      }),
