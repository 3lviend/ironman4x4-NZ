module Refinery
  module MediaReleases
    class MediaRelease < Refinery::Core::BaseModel
      ...
      validates_presence_of :title, :category, :description, :posted_at, :draft,
        :thumbnail_image, :priced_resource, :unpriced_resource
      validates_uniqueness_of :title
      validates_presence_of :publication, if: :published_at
      validates_presence_of :published_at, if: :publication
